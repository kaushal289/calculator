...
button_dot = Button(root, text=".", font=('Times New Roman', 20), image=button, compound=CENTER, borderwidth=0,
...
button_power = Button(root, text="^", font=('Times New Roman', 20), image=button, compound=CENTER, borderwidth=0,
                    command=lambda: button_click("**"))
