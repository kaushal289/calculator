...
cal_display = Label(root, text="", width=17, relief=SUNKEN, borderwidth=10, bg='lightblue', font=('Times New Roman', 25))
...
button_multiply = Button(root, text="*", font=('Times New Roman', 20, "bold"), image=squ, compound=CENTER,
                         borderwidth=0,
                         command=lambda: button_click("*"))
button_multiply.grid(row=2, column=3, columnspan=2)

button_subtract = Button(root, text="-", font=('Times New Roman', 20, "bold"), image=squ, compound=CENTER,
                         borderwidth=0,
                         command=lambda: button_click("-"))
button_subtract.grid(row=3, column=3, columnspan=2)

button_clear = Button(root, text="Clear", font=('Times New Roman', 20, "bold"), image=clear1, compound=CENTER,
                      borderwidth=0,
...
button_power = Button(root, text="^", font=('Times New Roman', 20, "bold"), image=button, compound=CENTER,
                      borderwidth=0, command=lambda: button_click("**"))
